...
import { fetchManagerBySlug, fetchManagerDrivers, fetchDrivers, fetchRaceResults, fetchRaces, fetchManagers, type Manager } from "@/lib/api";
            ...
            <div key={d.id} className="rounded-lg border border-border bg-card p-4 shadow-card">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  ...
                  {d.quote && <p className="text-xs italic text-muted-foreground mt-1">"{d.quote}"</p>}
                </div>
                <div className="text-right">
